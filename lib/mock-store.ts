...
export const INITIAL_PRICE_ITEMS: PriceItem[] = [
  { id: 'pi1', nama_item: 'Harga Dasar Unit', nominal: 450000000, keterangan: 'Harga standar sebelum diskon/biaya KPR' },
  { id: 'pi2', nama_item: 'Biaya Proses KPR', nominal: 15000000, keterangan: 'Notaris, Asuransi, Appraisal' },
  { id: 'pi3', nama_item: 'Biaya AJB & BBN', nominal: 12000000, keterangan: 'Akta Jual Beli & Balik Nama' },
  { id: 'pi4', nama_item: 'BPHTB', nominal: 18000000, keterangan: 'Bea Perolehan Hak atas Tanah dan Bangunan' },
];

export const INITIAL_LOCATIONS: Location[] = [
  { id: 'loc1', nama_lokasi: 'Perumahan Benteng Mutiara Mas', alamat: 'Perum Benteng Mutiara Mas, Desa Benteng Kec. Cempaka Kab. Purwakarta', kode_lokasi: 'BMM' },
  { id: 'loc2', nama_lokasi: 'Lansena Grand Hill Cibubur', alamat: 'Jl. Transyogi KM 6, Cibubur, Bogor', kode_lokasi: 'LGH' },
];

export const INITIAL_BLOCKS: Block[] = [
  { id: 'blk1', location_id: 'loc1', nama_blok: 'Blok A (Emerald)', location_nama: 'Perumahan Benteng Mutiara Mas' },
  { id: 'blk2', location_id: 'loc1', nama_blok: 'Blok B (Sapphire)', location_nama: 'Perumahan Benteng Mutiara Mas' },
  { id: 'blk3', location_id: 'loc2', nama_blok: 'Blok C (Diamond)', location_nama: 'Lansena Grand Hill Cibubur' },
];

export const INITIAL_UNIT_TYPES: UnitType[] = [
  { id: 'ut1', nama_type: 'Tipe 36/72 (Lotus)', luas_tanah: 72, luas_bangunan: 36 },
  { id: 'ut2', nama_type: 'Tipe 45/90 (Orchid)', luas_tanah: 90, luas_bangunan: 45 },
  { id: 'ut3', nama_type: 'Tipe 60/120 (Jasmine)', luas_tanah: 120, luas_bangunan: 60 },
];

export const INITIAL_SUBSIDY_TYPES: SubsidyType[] = [
  { id: 'sub1', nama_type: 'Non-Subsidi (Komersial)', keterangan: 'KPR Komersial / Cash Bertahap' },
  { id: 'sub2', nama_type: 'Subsidi FLPP', keterangan: 'Kredit Pemilikan Rumah Fasilitas Likuiditas Pembiayaan Perumahan' },
];
...
export const INITIAL_MARKETER_TYPES: MarketerType[] = [
  { id: 'mt1', nama_jenis: 'Internal Sales', skema_komisi_default: 'Gaji Pokok + 1.5% Fee dari Harga Unit' },
  { id: 'mt2', nama_jenis: 'Freelance Marketer', skema_komisi_default: '2.5% Fee dari Harga Unit (Akad / Lunas DP)' },
  { id: 'mt3', nama_jenis: 'Agency Properti', skema_komisi_default: '3.0% Fee Per Unit + Bonus Target Overriding' },
];
...
export const INITIAL_INVENTORY_ITEMS: InventoryItem[] = [
  { id: 'i1', nama_barang: 'Semen Gresik 50kg', satuan: 'Sak', kategori: 'Material Bangunan', stok: 120, min_stok: 30, harga_satuan: 68000 },
  { id: 'i2', nama_barang: 'Bata Ringan / Hebel 7.5cm', satuan: 'm3', kategori: 'Material Bangunan', stok: 15, min_stok: 20, harga_satuan: 620000 }, // Low stock alert!
  { id: 'i3', nama_barang: 'Besi Beton 10mm SNI', satuan: 'Batang', kategori: 'Besi & Metal', stok: 8, min_stok: 25, harga_satuan: 85000 }, // Low stock alert!
  { id: 'i4', nama_barang: 'Cat Tembok Exterior Dulux 20L', satuan: 'Pail', kategori: 'Cat & Finishing', stok: 45, min_stok: 10, harga_satuan: 1450000 },
];
...
export const INITIAL_PURCHASES: Purchase[] = [
  {
    ...
    status: 'Received',
    items: [
      { id: 'pi1', item_id: 'i1', item_nama: 'Semen Gresik 50kg', qty: 100, harga_satuan: 68000 },
    ],
  },
  {
    id: 'p2',
    ...
    status: 'Approved',
    items: [
      { id: 'pi2', item_id: 'i3', item_nama: 'Besi Beton 10mm SNI', qty: 200, harga_satuan: 85000 },
    ],
  },
];
...
export const INITIAL_CASH_BANK_ACCOUNTS: CashBankAccount[] = [
  { id: 'cba1', nama_akun: 'Kas Operasional Kantor', jenis: 'Kas', saldo: 48500000 },
  { id: 'cba2', nama_akun: 'Bank BCA Operasional', jenis: 'Bank', no_rekening: '8830-192-881', saldo: 1250000000 },
  { id: 'cba3', nama_akun: 'Bank Mandiri Escrow KPR', jenis: 'Bank', no_rekening: '118-0099-281', saldo: 2450000000 },
];
...
export const INITIAL_CHART_OF_ACCOUNTS: ChartOfAccount[] = [
  ...
  { id: 'coa3', kode_akun: '2010', nama_akun: 'Hutang Bank KPR Proyek', kategori: 'Kewajiban' },
  { id: 'coa4', kode_akun: '4010', nama_akun: 'Pendapatan Penjualan Rumah', kategori: 'Pendapatan' },
  { id: 'coa5', kode_akun: '5010', nama_akun: 'Bebam Constructing & Material', kategori: 'Beban' },
  { id: 'coa6', kode_akun: '5020', nama_akun: 'Beban Komisi Marketing', kategori: 'Beban' },
];
...
export const INITIAL_USERS: UserProfile[] = [
  { id: 'usr1', nama: 'Administrator Lansena', email: 'admin@lansenaproperty.com', role: 'Admin', is_active: true, last_login_at: '2026-08-03T12:00:00Z' },
  { id: 'usr2', nama: 'Marketing Executive', email: 'marketing@lansenaproperty.com', role: 'Marketing', is_active: true, last_login_at: '2026-08-03T11:30:00Z' },
  { id: 'usr3', nama: 'Kepala Gudang', email: 'gudang@lansenaproperty.com', role: 'Gudang', is_active: true, last_login_at: '2026-08-02T16:45:00Z' },
  { id: 'usr4', nama: 'Finance Officer', email: 'finance@lansenaproperty.com', role: 'Finance', is_active: true, last_login_at: '2026-08-03T09:15:00Z' },
  { id: 'usr5', nama: 'Management Viewer', email: 'viewer@lansenaproperty.com', role: 'Viewer', is_active: true, last_login_at: '2026-07-30T10:00:00Z' },
];
