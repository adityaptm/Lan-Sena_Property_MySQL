...
// Wrapper for an A4 Page with exact page-break styling
export const PageWrapper: React.FC<{ children: React.ReactNode; pageNum?: number }> = ({ children }) => {
  return (
    <div className="kpr-page bg-white mx-auto shadow-md print:shadow-none border border-slate-200 print:border-none p-8 print:p-0 my-4 print:my-0 w-[210mm] min-h-[297mm] text-[8.5pt] leading-[1.3] text-black font-sans box-border relative flex flex-col justify-between">
      <div>{children}</div>
    </div>
  );
};
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-4">
        <p className="text-xs uppercase">{formatCode}</p>
        <p className="text-sm underline mt-1">BERITA ACARA SERAH TERIMA</p>
        <p className="text-sm underline">RUMAH UMUM TAPAK</p>
      </div>
      ...
      <table className="w-full mb-3">
        <tbody>
          <tr><td className="w-6 py-0.5">1</td><td className="w-48">Nama</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
      ...
      <p className="mb-2 italic">Selanjutnya disebut "Pihak Kedua"</p>

      <p className="font-semibold mb-1">Atas 1 (satu) unit Rumah Umum Tapak pada lokasi sebagai berikut :</p>
      <table className="w-full mb-3">
        <tbody>
          <tr><td className="w-6 py-0.5">1</td><td className="w-48">Nama Perumahan</td><td className="w-3">:</td><td className="font-semibold">{c.namaPerumahan}</td></tr>
      ...
      <p className="mb-2 italic">selanjutnya disebut "Objek Serah Terima"</p>

      <p className="mb-1 font-semibold">Objek Serah Terima dengan kondisi laik fungsi dan dilengkapi dengan :</p>
      <ol className="list-decimal pl-5 space-y-0.5 mb-3">
      ...
      <div className="grid grid-cols-2 gap-4 text-center mt-6">
        <div>
          ...
          <p className="text-[7.5pt] text-slate-600">Tanda tangan dan Nama Pengembang</p>
        </div>
        <div>
          <p className="font-semibold">PIHAK KEDUA,</p>
          <div className="h-16 mt-4" />
          <p className="font-bold underline">({c.namaPemohon})</p>
          <p className="text-[7.5pt] text-slate-600">Tanda tangan dan nama lengkap</p>
        </div>
      </div>
      <p className="text-[7pt] italic text-slate-500 mt-4">*) Pilih salah Satu</p>
    </PageWrapper>
  );
};
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-6">
        <p className="text-sm underline uppercase">SURAT PERNYATAAN PENGHASILAN</p>
      </div>
      ...
      <table className="w-full mb-4">
        <tbody>
          <tr><td className="w-44 py-1">Nama</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
      ...
      <div className="grid grid-cols-2 gap-4 text-center mt-4">
        <div>
          ...
          <p className="text-[7.5pt] text-slate-600">Nama lengkap & jabatan</p>
        </div>
        <div>
          <p>Yang membuat pernyataan,</p>
          <div className="h-16 flex items-center justify-center text-[7pt] text-slate-400 my-1">
            <span className="border border-dashed border-slate-400 px-2 py-0.5 rounded">Materai 10.000</span>
          </div>
          <p className="font-bold underline">({c.namaPemohon})</p>
          <p className="text-[7.5pt] text-slate-600">Nama Lengkap</p>
        </div>
      </div>
      <p className="text-[7pt] italic text-slate-500 mt-6">*diberikan cap perusahaan/instansi</p>
    </PageWrapper>
  );
};
...
export const DocTidakMemilikiRumah: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-6">
        <p className="text-sm underline uppercase">SURAT PERNYATAAN TIDAK MEMILIKI RUMAH</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 text-center mt-4">
        <div>
          ...
          <div className="h-20" />
          <p className="font-bold underline">( .................................................. )</p>
          <p className="text-[7.5pt] text-slate-600">Nama lengkap dan Jabatan</p>
        </div>
        <div>
          <p>Yang membuat pernyataan,</p>
          <div className="h-16 flex items-center justify-center text-[7pt] text-slate-400 my-1">
      ...
      <p className="text-[7pt] italic text-slate-500 mt-6">*diberikan cap kelurahan/perusahaan/instansi</p>
    </PageWrapper>
  );
};
...
export const DocTidakBekerjaPasangan: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      <div className="text-xs italic text-slate-500 mb-2">[ Minta KOP SURAT DESA ]</div>
      <div className="text-center font-bold mb-6">
        <p className="text-sm underline uppercase">SURAT PERNYATAAN TIDAK MEMILIKI PEKERJAAN</p>
        <p className="text-xs uppercase">(TIDAK BEKERJA / TIDAK MEMPUNYAI PEKERJAAN)</p>
      </div>
      ...
      <table className="w-full mb-4">
        <tbody>
          <tr><td className="w-44 py-1">Nama Lengkap</td><td className="w-3">:</td><td className="font-semibold">{c.namaPasangan || '...................................................'}</td></tr>
      ...
      <div className="grid grid-cols-2 gap-4 text-center mt-4">
        <div>
          ...
          <div className="h-20" />
          <p className="font-bold underline">( .................................................. )</p>
          <p className="text-[7.5pt] text-slate-600">Nama Lengkap & Stempel</p>
        </div>
        <div>
          <p>Yang membuat pernyataan,</p>
          <div className="h-16 flex items-center justify-center text-[7pt] text-slate-400 my-1">
          ...
          <p className="text-[7.5pt] text-slate-600">Nama Lengkap Pasangan</p>
        </div>
      </div>
    </PageWrapper>
  );
...
export const DocBlokUnitDibiayai: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-4">
        <p className="text-sm underline uppercase">LAMPIRAN BLOK UNIT YANG DI BIAYAI</p>
      </div>

      <table className="w-full mb-4 text-[8.5pt]">
        <tbody>
          <tr><td className="w-52 py-0.5">NAMA PERUMAHAN</td><td className="w-3">:</td><td className="font-semibold">{c.namaPerumahan}</td></tr>
      ...
      <table className="w-full border-collapse border border-black text-center text-[8pt] mb-8">
        <thead>
          <tr className="bg-slate-100 font-bold">
            <th className="border border-black p-1.5 w-12">NO</th>
            <th className="border border-black p-1.5">BLOK/KAVLING</th>
            <th className="border border-black p-1.5">LUAS BANGUNAN</th>
            <th className="border border-black p-1.5">LUAS TANAH</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="border border-black p-1.5 font-bold">1</td>
            <td className="border border-black p-1.5 font-semibold text-left pl-4">{c.blokUnit}</td>
            <td className="border border-black p-1.5">{c.luasBangunan}</td>
            <td className="border border-black p-1.5">{c.luasTanah}</td>
          </tr>
          {[2, 3, 4, 5, 6, 7].map((num) => (
            <tr key={num}>
              <td className="border border-black p-2 text-slate-400">{num}</td>
      ...
      <div className="flex justify-end mt-12 pr-8">
        <div className="text-center w-64">
          ...
          <div className="h-24" />
          <p className="font-bold underline">{c.direktur}</p>
          <p className="text-[8pt] text-slate-600">{c.pengembang}</p>
        </div>
      </div>
    </PageWrapper>
  );
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-3">
        <p className="text-xs uppercase">FORMAT G</p>
        <p className="text-sm underline">SURAT PERNYATAAN PEMOHON KPR SEJAHTERA</p>
      </div>

      <p className="mb-1 text-[8pt]">Yang bertandatangan di bawah ini :</p>

      {/* 1. Pemohon */}
      <table className="w-full mb-1 text-[8pt]">
        <tbody>
          <tr><td className="w-4 font-bold align-top">1</td><td className="w-36 py-0.5">Nama</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
      ...
      <p className="italic text-[7.5pt] pl-4 -mt-1 mb-2 font-medium">Selaku Pemohon</p>

      {/* 2. Pasangan */}
      <table className="w-full mb-1 text-[8pt]">
        <tbody>
          <tr><td className="w-4 font-bold align-top">2</td><td className="w-36 py-0.5">Nama</td><td className="w-3">:</td><td className="font-semibold">{c.namaPasangan || '...................................................'}</td></tr>
      ...
      <p className="italic text-[7.5pt] pl-4 -mt-1 mb-2 font-medium">Selaku suami/ istri *) Pemohon</p>

      <p className="font-semibold text-[8pt] mb-1">Menyatakan dengan sesungguhnya bahwa :</p>
      <div className="space-y-1 text-justify text-[7.5pt] leading-snug pl-2">
      ...
      <p className="text-justify text-[7.5pt] mt-2 mb-1">
        Demikian Surat Pernyataan ini saya buat dengan sebenar-benarnya tanpa paksaan dari pihak manapun.
      </p>

      <div className="text-right text-[7.5pt] mb-1">
        <p>Purwakarta, .................................... {c.currentYear}</p>
      </div>

      <div className="grid grid-cols-2 gap-2 text-center text-[7.5pt]">
        <div>
          <p>Menyetujui,</p>
          <div className="h-12" />
          <p className="font-bold underline">({c.namaPasangan || '...................................................'}*))</p>
          <p className="text-[7pt] text-slate-500">Nama Suami/Istri Pemohon</p>
        </div>
        <div>
          <p>Yang Membuat Pernyataan,</p>
          <div className="h-12 flex items-center justify-center text-[6.5pt] text-slate-400">
            <span className="border border-dashed border-slate-400 px-1 py-0.5 rounded">Materai 10.000</span>
          </div>
          <p className="font-bold underline">({c.namaPemohon})</p>
          <p className="text-[7pt] text-slate-500">Nama Pemohon</p>
        </div>
      </div>
      ...
      <div className="text-center text-[7.5pt] mt-2">
        ...
        <div className="h-10" />
        <p className="font-bold underline">( ................................................................ )</p>
        <p className="text-[7pt] text-slate-600">Nama lengkap dan stempel</p>
      </div>
      <p className="text-[6.5pt] italic text-slate-500">*) Pilih Salah Satu</p>
    </PageWrapper>
  );
};
...
export const DocBjbFormQ: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      <div className="text-right text-[8pt] mb-2 font-medium">
        Bandung, .................................... {c.currentYear}
      </div>
      <div className="font-bold text-[8.5pt] mb-3">
        <p className="text-xs">FORM Q - KANTOR CABANG</p>
        <p className="underline text-sm mt-0.5">SURAT PERMOHONAN PEMBAYARAN SBUM</p>
      </div>

      <table className="w-full mb-3 text-[8pt]">
        <tbody>
          <tr><td className="w-24">Nomor</td><td className="w-3">:</td><td>............................................................</td></tr>
      ...
      <p className="text-justify text-[8pt] mb-2">
      ...
      <p className="font-semibold text-[8pt] mb-1">Jumlah subsidi bunga kredit perumahan :</p>
      <table className="w-full border-collapse border border-black text-center text-[7.5pt] mb-3">
        <thead>
          <tr className="bg-slate-100 font-bold">
            <th className="border border-black p-1" rowSpan={2}>No</th>
            <th className="border border-black p-1" rowSpan={2}>Jenis KPR</th>
            <th className="border border-black p-1" colSpan={2}>Total KPR</th>
            <th className="border border-black p-1" colSpan={2}>Total SBUM Diminta</th>
          </tr>
          <tr className="bg-slate-100 font-bold">
            <th className="border border-black p-1">(unit)</th>
            <th className="border border-black p-1">(Rp.)</th>
            <th className="border border-black p-1">(unit)</th>
            <th className="border border-black p-1">(Rp.)</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td className="border border-black p-1 text-left font-medium pl-2">KPR SSB Tapak</td>
          ...
          <tr>
            ...
            <td className="border border-black p-1 text-left font-medium pl-2">KPR Sejahtera Tapak</td>
            <td className="border border-black p-1">1</td>
            <td className="border border-black p-1">{c.hargaJual}</td>
            <td className="border border-black p-1">1</td>
            <td className="border border-black p-1">{c.sbumStr}</td>
          </tr>
      ...
      <p className="text-[8pt] mb-4">Demikian kami sampaikan, atas perhatiannya kami ucapkan terima kasih.</p>
      ...
      <div className="mt-6 text-[7pt] text-slate-600">
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-6">
        ...
        <p className="text-sm underline uppercase mt-1">SURAT PERNYATAAN KESEDIAAN PEMBAYARAN KEKURANGAN UANG MUKA</p>
        <p className="text-xs uppercase">(JIKA SBUM TIDAK DIBAYARKAN OLEH SATKER KEMENPUPERA)</p>
      </div>
      ...
      <div className="flex justify-end mt-12 pr-12 text-center">
        <div>
          <p>Purwakarta, .................................... {c.currentYear}</p>
          <div className="h-20 flex items-center justify-center text-[7pt] text-slate-400 my-2">
            <span className="border border-dashed border-slate-400 px-2 py-0.5 rounded">Materai 10.000</span>
          </div>
          <p className="font-bold underline">({c.namaPemohon})</p>
          <p className="text-[7.5pt] text-slate-600">Nama Debitur</p>
        </div>
      </div>
    </PageWrapper>
  );
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-3">
        ...
        <p className="text-xs uppercase">Pemindahbukuan Pembayaran Kepada Pengembang</p>
      </div>

      <p className="text-[8pt] mb-1">Yang bertanda tangan dibawah ini :</p>
      <table className="w-full mb-2 text-[8pt]">
        <tbody>
          <tr><td className="w-40 py-0.5">Nama</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
      ...
      <p className="text-[8pt] font-semibold mb-2">(Selanjutnya disebut PEMBERI KUASA)</p>

      <p className="text-[8pt] mb-1">PEMBERI KUASA adalah pemegang rekening Tabungan pada PT. Bank Pembangunan Daerah Jawa Barat dan Banten, Tbk. Sebagai berikut :</p>
      <table className="w-full mb-2 text-[8pt]">
        <tbody>
          <tr><td className="w-40 py-0.5">Nomor Rekening</td><td className="w-3">:</td><td>_____________________________________________________</td></tr>
      ...
      <p className="text-[8pt] font-semibold mb-2">(Selanjutnya disebut REKENING PEMBERI KUASA)</p>

      <p className="text-justify text-[7.5pt] mb-2 leading-relaxed">
      ...
      <p className="font-bold text-center text-[8pt] my-1">KHUSUS</p>
      <p className="text-justify text-[7.5pt] mb-2 leading-relaxed">
      ...
      <div className="text-right text-[7.5pt] mb-2">
        <p>Purwakarta, .................................... {c.currentYear}</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2 text-center text-[7.5pt]">
        <div>
          ...
          <div className="h-14" />
          <p className="font-bold underline">( ................................................................ )</p>
          <p className="text-[7pt] text-slate-600">Nama & Jabatan</p>
        </div>
        <div>
          <p className="font-semibold">PEMBERI KUASA,</p>
          <div className="h-14 flex items-center justify-center text-[6.5pt] text-slate-400">
            <span className="border border-dashed border-slate-400 px-1 py-0.5 rounded">Materai 10.000</span>
          </div>
          <p className="font-bold underline">({c.namaPemohon})</p>
        </div>
      ...
      <div className="text-center text-[7.5pt] mt-2">
        ...
        <div className="h-10" />
        <p className="font-bold underline">({c.namaPasangan || '...................................................'})</p>
        <p className="text-[7pt] text-slate-600">Nama Suami/Istri Pemohon</p>
      </div>
    </PageWrapper>
  );
};
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-4">
        ...
        <p className="text-sm underline uppercase mt-1">SURAT PENGAKUAN KEKURANGAN BAYAR UANG MUKA</p>
      </div>

      <p className="mb-2 text-[8pt]">Yang bertanda tangan dibawah ini :</p>
      <table className="w-full mb-3 text-[8pt]">
        <tbody>
      ...
      <p className="text-justify text-[8pt] mb-3 leading-relaxed">
      ...
      <table className="w-full mb-3 text-[8pt]">
        <tbody>
          <tr><td className="w-52 py-0.5">Nama</td><td className="w-3">:</td><td className="font-semibold">{c.pengembang}</td></tr>
      ...
      <p className="text-justify text-[8pt] mb-4 leading-relaxed">
      ...
      <div className="grid grid-cols-2 gap-4 text-center text-[8pt] mt-4">
        <div>
          <p className="font-semibold">Menyetujui</p>
          <p className="text-[7.5pt] text-slate-600">(Jabatan yang mewakili pengembang)</p>
          <div className="h-16 flex items-center justify-center text-[7pt] text-slate-400">
            <span>Ttd dan cap perusahaan</span>
          </div>
          <p className="font-bold underline">({c.direktur})</p>
          <p className="text-[7.5pt] text-slate-600">{c.pengembang}</p>
        </div>
        <div>
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-4">
        ...
        <p className="text-sm underline uppercase mt-1">SURAT PERMOHONAN SUBSIDI BANTUAN UANG MUKA</p>
      </div>
      ...
      <p className="text-[8pt] mb-2 font-semibold">Perihal : Permohonan Subsidi Bantuan Uang Muka</p>

      <p className="text-[8pt] mb-2">Saya yang bertanda tangan dibawah ini :</p>
      <table className="w-full mb-3 text-[8pt]">
        <tbody>
          <tr><td className="w-44 py-0.5">Nama</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
          <tr><td className="py-0.5">Tempat/ Tgl Lahir</td><td>:</td><td>{c.tempatLahirPemohon}, {c.tglLahirPemohon}</td></tr>
      ...
      <table className="w-full mb-3 text-[8pt]">
        <tbody>
          <tr><td className="w-52 py-0.5">Nama Pengembang</td><td className="w-3">:</td><td className="font-semibold">{c.pengembang}</td></tr>
          <tr><td className="py-0.5">Alamat Rumah Yang Dibeli</td><td>:</td><td>{c.namaPerumahan} Blok {c.blokUnit}</td></tr>
          <tr><td className="py-0.5">Harga Jual Rumah</td><td>:</td><td className="font-semibold">{c.hargaJual}</td></tr>
          <tr><td className="py-0.5">Besaran Uang Muka</td><td>:</td><td>{c.dpTotal}</td></tr>
          <tr><td className="py-0.5">Bank Pelaksana</td><td>:</td><td>PT. Bank Pembangunan Daerah Jawa Barat dan Banten, Tbk. (bank bjb)</td></tr>
      ...
      <p className="text-[8pt] mb-6">Demikian kami sampaikan, atas perhatiannya kami ucapkan terima kasih.</p>

      <div className="flex justify-end pr-12 text-center text-[8pt]">
        <div>
          <p>Purwakarta, .................................... {c.currentYear}</p>
      ...
      <p className="text-[7pt] italic text-slate-500 mt-6">*) diisi dengan nama direktur atau yang mewakili pengembang</p>
    </PageWrapper>
  );
};
...
export const DocBjbPembatalanFlpp: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-6">
        <p className="text-sm underline uppercase">SURAT PERNYATAAN PEMBATALAN DEBITUR FLPP</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 text-center mt-4">
        <div>
          ...
          <div className="h-20" />
          <p className="font-bold underline">( .................................................. )</p>
          <p className="text-[7.5pt] text-slate-600">(Nama Pejabat) (Jabatan)</p>
        </div>
        <div>
          <p>Yang membuat pernyataan,</p>
          <div className="h-16 flex items-center justify-center text-[7pt] text-slate-400 my-1">
...
export const DocBjbUrutanFasilitasKredit: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      ...
      <p className="text-[8pt] mb-1">Kami yang bertandatangan di bawah ini :</p>
      <table className="w-full mb-1 text-[7.5pt]">
        <tbody>
          <tr><td className="w-40 py-0.5 font-semibold">Nama Calon Debitur</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
          <tr><td className="py-0.5">Tempat/ Tgl Lahir</td><td>:</td><td>{c.tempatLahirPemohon}, {c.tglLahirPemohon}</td></tr>
          <tr><td className="py-0.5">No. KTP</td><td>:</td><td>{c.nikPemohon}</td></tr>
          <tr><td className="py-0.5 align-top">Alamat</td><td className="align-top">:</td><td className="align-top">{c.alamatPemohon}</td></tr>
      ...
      <p className="text-[7.5pt] mb-1">
        Adalah suami-istri berdasarkan Buku Nikah (atau yang disamakan dengan itu) Nomor : ________________ tanggal ___________
      </p>
      <p className="text-[7.5pt] font-semibold mb-1">Dengan ini menyatakan bahwa :</p>
      <ol className="list-decimal pl-4 space-y-0.5 text-justify text-[7pt]">
      ...
      <table className="w-full border-collapse border border-black text-center text-[6.5pt] my-1">
        <thead>
          <tr className="bg-slate-100 font-bold">
      ...
      <div className="space-y-0.5 text-justify text-[7pt]">
      ...
      <p className="text-justify text-[7pt] mt-1 mb-1">
      ...
      <div className="text-right text-[7pt] mb-1">
        <p>Purwakarta, .................................... {c.currentYear}</p>
      </div>

      <div className="grid grid-cols-2 gap-2 text-center text-[7pt]">
        <div>
          <p className="font-semibold">Yang Membuat Pernyataan,</p>
          <div className="h-10 flex items-center justify-center text-[6pt] text-slate-400">
            <span className="border border-dashed border-slate-400 px-1 py-0.5 rounded">Materai 10.000</span>
          </div>
          <p className="font-bold underline">({c.namaPemohon})</p>
        </div>
...
export const DocBjbChecklist: React.FC<{ data: BankKprDocData; isKomersil?: boolean }> = ({ isKomersil = false }) => {
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-4">
        <p className="text-sm underline uppercase">CHECKLIST DOKUMEN bjb KPR {isKomersil ? 'KOMERSIL' : 'Sejahtera FLPP'}</p>
        <p className="text-xs uppercase">{isKomersil ? 'Dokumen Pengajuan KPR Non-Subsidi' : 'Dokumen FLPP dan Dokumen SBUM'}</p>
      </div>

      <table className="w-full border-collapse border border-black text-[7.5pt] mb-6">
        <thead>
          <tr className="bg-slate-100 font-bold text-center">
            <th className="border border-black p-1 w-8">No</th>
            <th className="border border-black p-1">Dokumen</th>
            <th className="border border-black p-1 w-12">Ada</th>
            <th className="border border-black p-1 w-16">Tidak Ada</th>
            <th className="border border-black p-1 w-56">Keterangan</th>
          </tr>
        </thead>
        <tbody>
          <tr className="font-semibold bg-slate-50"><td className="border border-black p-1 text-center">1</td><td className="border border-black p-1" colSpan={4}>Dokumen Pengajuan {isKomersil ? 'Komersil' : 'FLPP'}</td></tr>
          <tr><td className="border border-black p-1 text-center">a</td><td className="border border-black p-1">Format E : Surat Pernyataan Penghasilan</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Memakai kop surat perusahaan</td></tr>
          <tr><td className="border border-black p-1 text-center">b</td><td className="border border-black p-1">Format F : Surat Pernyataan Tidak Memiliki Rumah (debitur dan pasangan)</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Memakai kop surat kelurahan dan harus sesuai format</td></tr>
          <tr><td className="border border-black p-1 text-center">c</td><td className="border border-black p-1">Format G : Surat Pernyataan Pemohon KPR Sejahtera</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Harus di ttd oleh pejabat instansi kerja / kelurahan</td></tr>
          <tr><td className="border border-black p-1 text-center">d</td><td className="border border-black p-1">Format H : Berita Acara Serah Terima Rumah Umum Tapak</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Memakai kop surat Pengembang, di ttd dan stempel</td></tr>
          <tr><td className="border border-black p-1 text-center">e</td><td className="border border-black p-1">Lampiran Blok Unit yang dibiayai</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Kop pengembang, materai 10.000 dan stempel</td></tr>
          <tr><td className="border border-black p-1 text-center">f</td><td className="border border-black p-1">Surat Pernyataan Tidak Memiliki Pekerjaan (Pasangan)</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Memakai kop kelurahan</td></tr>
          <tr><td className="border border-black p-1 text-center">g</td><td className="border border-black p-1">Surat Pernyataan Pembatalan Debitur FLPP</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Format bjb</td></tr>

          <tr className="font-semibold bg-slate-50"><td className="border border-black p-1 text-center">2</td><td className="border border-black p-1" colSpan={4}>Dokumen Lainnya</td></tr>
          <tr><td className="border border-black p-1 text-center">a</td><td className="border border-black p-1">Bukti telah membayar uang muka</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Bukti setor/pinbuk ke rekening Pengembang</td></tr>
          <tr><td className="border border-black p-1 text-center">b</td><td className="border border-black p-1">Bukti dan Dokumentasi OTS</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Bukti kunjungan dan foto OTS</td></tr>
          <tr><td className="border border-black p-1 text-center">c</td><td className="border border-black p-1">Surat Pernyataan Urutan Fasilitas Kredit (LTV)</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Ditandatangani debitur dan pasangan</td></tr>

          {!isKomersil && (
            <>
              <tr className="font-semibold bg-slate-50"><td className="border border-black p-1 text-center">3</td><td className="border border-black p-1" colSpan={4}>Dokumen Pengajuan SBUM</td></tr>
              <tr><td className="border border-black p-1 text-center">a</td><td className="border border-black p-1">Lampiran 2 : Surat Permohonan Subsidi Bantuan Uang Muka</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Ditujukan ke Ditjen KemenPUPR</td></tr>
              <tr><td className="border border-black p-1 text-center">b</td><td className="border border-black p-1">Lampiran 3 : Surat Pengakuan Kekurangan Bayar Uang Muka</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Di ttd dan stempel Pengembang</td></tr>
              <tr><td className="border border-black p-1 text-center">c</td><td className="border border-black p-1">Lampiran 6 : Surat Kuasa Pendebetan SBUM</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Di ttd oleh Pemimpin Cabang & Debitur</td></tr>
              <tr><td className="border border-black p-1 text-center">d</td><td className="border border-black p-1">Lampiran 7 : Surat Pernyataan Kesediaan Pembayaran Kekurangan UM</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Materai 10.000</td></tr>
              <tr><td className="border border-black p-1 text-center">e</td><td className="border border-black p-1">Form Q : Surat Permohonan Pembayaran SBUM</td><td className="border border-black p-1 text-center">v</td><td className="border border-black p-1"></td><td className="border border-black p-1">Dari Cabang ke Divisi KPR Pusat</td></tr>
            </>
          )}
        </tbody>
      </table>

      <div className="grid grid-cols-2 gap-4 text-center text-[8pt] mt-8">
        <div>
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-4">
        ...
        <p className="text-xs uppercase">(BANK BRI)</p>
      </div>

      <p className="mb-2 text-[8pt]">Yang bertanda-tangan di bawah ini :</p>
      <table className="w-full mb-1 text-[8pt]">
        <tbody>
      ...
      <p className="text-[6.5pt] italic text-slate-500">*) Coret salah satu yang tidak perlu</p>
    </PageWrapper>
  );
};
...
export const DocBriStatusKepemilikanRumah: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-6">
        <p className="text-sm underline uppercase">SURAT PERNYATAAN STATUS KEPEMILIKAN RUMAH</p>
      </div>

      <p className="mb-3">Saya/kami yang bertandatangan di bawah ini :</p>

      <table className="w-full border-collapse border border-black text-[8pt] mb-6">
        <thead>
          <tr className="bg-slate-100 font-bold text-center">
            <th className="border border-black p-2 w-48">Keterangan</th>
            <th className="border border-black p-2">Pemohon Utama</th>
            <th className="border border-black p-2">Pemohon Pendamping (Pasangan)</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <ol className="list-disc pl-6 space-y-1.5 text-justify mb-6">
...
export const DocBtnLampiran3: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-3">
        <p className="text-xs uppercase">Lampiran III</p>
        <p className="text-sm underline uppercase">SURAT PERNYATAAN PERSETUJUAN</p>
        <p className="text-sm underline uppercase">PENYALURAN KPR SEJAHTERA FLPP TA 2026</p>
      </div>

      <p className="text-[8pt] mb-1">Yang bertanda tangan di bawah ini:</p>
      <table className="w-full mb-1 text-[8pt]">
        <tbody>
          <tr><td className="w-40 py-0.5">Nama Lengkap</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
          <tr><td className="py-0.5">No. KTP</td><td>:</td><td>{c.nikPemohon}</td></tr>
      ...
      <p className="italic text-[7.5pt] pl-4 -mt-1 mb-2 font-medium">Selaku istri/suami* pemohon.</p>
      ...
      <ol className="list-decimal pl-4 space-y-1.5 text-justify text-[7.5pt] leading-snug mb-3">
        <li>
      ...
      <p className="text-justify text-[7.5pt] mb-3 leading-relaxed">
        Demikian surat pernyataan ini saya buat dengan sebenarnya tanpa paksaan dari pihak manapun dan apabila di kemudian hari pernyataan saya ini tidak benar, saya bersedia mengembalikan seluruh subsidi yang saya terima.
      </p>

      <div className="text-right text-[7.5pt] mb-1">
        <p>Purwakarta, .................................... {c.currentYear}</p>
        <p className="text-[7pt] text-slate-500">Kota/Kabupaten, tanggal bulan tahun</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2 text-center text-[7.5pt]">
        <div>
          ...
          <div className="h-12" />
          <p className="font-bold underline">({c.namaPasangan || '...................................................'})</p>
          <p className="text-[7pt] text-slate-500">Nama Lengkap Suami/Istri*</p>
        </div>
        <div>
          <p>Yang Membuat Pernyataan,</p>
          <div className="h-12 flex items-center justify-center text-[6.5pt] text-slate-400">
          ...
          <p className="font-bold underline">({c.namaPemohon})</p>
          <p className="text-[7pt] text-slate-500">Nama Lengkap Pemohon</p>
        </div>
      </div>
      ...
      <div className="text-center text-[7.5pt] mt-2">
        ...
        <div className="h-10" />
        <p className="font-bold underline">({c.direktur})</p>
        <p className="text-[7pt] text-slate-600">Nama Lengkap, Jabatan dan Stempel</p>
      </div>
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-4">
        ...
        <p className="text-sm underline uppercase mt-1">SURAT PERNYATAAN DEVELOPER</p>
      </div>

      <p className="mb-2 text-[8pt]">Yang bertanda tangan di bawah ini:</p>
      <table className="w-full mb-3 text-[8pt]">
        <tbody>
          <tr><td className="w-40 py-1">Nama Lengkap</td><td className="w-3">:</td><td className="font-semibold">{c.direktur}</td></tr>
      ...
      <p className="font-semibold text-[8pt] mb-2">Dengan ini menyatakan bahwa debitur:</p>
      <table className="w-full mb-4 text-[8pt]">
        <tbody>
          <tr><td className="w-40 py-1">Nama Lengkap</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
          <tr><td className="py-1">No. KTP</td><td>:</td><td>{c.nikPemohon}</td></tr>
          <tr><td className="py-1">Alamat Perumahan</td><td>:</td><td className="font-semibold">{c.namaPerumahan} Blok ({c.blokUnit})</td></tr>
        </tbody>
      </table>

      <p className="text-justify text-[8.5pt] mb-4 leading-relaxed">
      ...
      <p className="text-justify text-[8.5pt] mb-8">
      ...
      <div className="grid grid-cols-2 gap-4 text-center text-[8pt] mt-4">
        <div>
          ...
          <div className="h-20" />
          <p className="font-bold underline">( .................................................. )</p>
          <p className="text-[7.5pt] text-slate-600">Nama Lengkap Developer</p>
        </div>
        <div>
          <p className="font-semibold">Yang Menyatakan,</p>
          <div className="h-20 flex items-center justify-center text-[7pt] text-slate-400">
            <span>Stempel Developer & TTD</span>
          </div>
          <p className="font-bold underline">({c.direktur})</p>
          <p className="text-[7.5pt] text-slate-600">Direktur Utama {c.pengembang}</p>
        </div>
      </div>
      <p className="text-[7pt] italic text-slate-500 mt-6">*) coret salah yang tidak perlu</p>
    </PageWrapper>
  );
};
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-6">
        ...
        <p className="text-sm underline uppercase mt-1">SURAT PERNYATAAN PENYERAHAN SPT PPH</p>
      </div>
      ...
      <ol className="list-decimal pl-6 space-y-2 text-justify mb-6">
        <li>
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-3">
        ...
        <p className="text-sm underline uppercase">SURAT PERNYATAAN VERIFIKASI</p>
      </div>

      <p className="text-[8pt] mb-1">Yang bertanda tangan di bawah ini :</p>
      <table className="w-full mb-2 text-[8pt]">
        <tbody>
          <tr><td className="w-36 py-0.5">Nama</td><td className="w-3">:</td><td>............................................................</td></tr>
      ...
      <p className="font-bold text-center text-[8.5pt] my-1">MENYATAKAN</p>
      ...
      <p className="text-justify text-[7.5pt] mt-3 mb-2">
        Demikian surat pernyataan ini saya buat dengan sebenar-benarnya tanpa paksaan dari pihak manapun.
      </p>
      ...
      <p className="text-[6.5pt] italic text-slate-500 mt-2">*) coret yang tidak perlu</p>
    </PageWrapper>
  );
};
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-3">
        ...
        <p className="text-sm underline uppercase">SURAT KUASA</p>
      </div>
      ...
      <p className="text-[8pt] italic pl-2 mb-2 font-medium">yang dalam hal ini bertindak untuk dan atas nama sendiri. Selanjutnya disebut <span className="font-bold">"Pemberi Kuasa"</span>.</p>

      <p className="text-justify text-[7.5pt] mb-1">
      ...
      <p className="font-bold text-center text-[8pt] my-0.5">KHUSUS</p>
      <p className="text-[7.5pt] mb-1">dengan ini Pemberi Kuasa memberikan kuasa kepada Penerima Kuasa untuk dapat melakukan hal-hal sebagai berikut:</p>
      ...
      <div className="space-y-1 text-justify text-[7.5pt] leading-snug pl-2">
        ...
        <div className="pl-3">
          ...
          <table className="w-full">
            <tbody>
              <tr><td className="w-36">Nama Pengembang</td><td className="w-3">:</td><td className="font-semibold">{c.pengembang}</td></tr>
      ...
      <p className="text-justify text-[7.5pt] mt-2 mb-2">
      ...
      <div className="grid grid-cols-2 gap-4 text-center text-[7.5pt] mt-2">
        <div>
      ...
      <p className="text-[6.5pt] italic text-slate-500">*) coret yang tidak perlu</p>
    </PageWrapper>
  );
};
...
export const DocBtnLampiran13: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      ...
      <p className="text-[8pt] mb-2 font-semibold">Perihal : Permohonan Subsidi Bantuan Uang Muka Perumahan</p>

      <p className="text-[8pt] mb-2">Saya yang bertanda tangan di bawah ini:</p>
      <table className="w-full mb-3 text-[8pt]">
        <tbody>
          <tr><td className="w-44 py-0.5">Nama</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
          <tr><td className="py-0.5">Tempat, Tanggal Lahir</td><td>:</td><td>{c.tempatLahirPemohon}, {c.tglLahirPemohon}</td></tr>
      ...
      <p className="text-[7pt] italic text-slate-500 mt-6">*) diisi nama direktur/atau yang mewakili pengembang</p>
    </PageWrapper>
  );
};
...
export const DocBtnLampiran14: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      ...
      <p className="mb-2 text-[8pt]">Saya yang bertanda tangan di bawah ini:</p>
      <table className="w-full mb-3 text-[8pt]">
        <tbody>
          <tr><td className="w-44 py-0.5">Nama</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
          <tr><td className="py-0.5">Tempat, Tanggal Lahir</td><td>:</td><td>{c.tempatLahirPemohon}, {c.tglLahirPemohon}</td></tr>
      ...
      <div className="grid grid-cols-2 gap-4 text-center text-[8pt] mt-6">
        <div>
          <p className="font-semibold">Menyetujui,</p>
          <p className="text-[7.5pt] text-slate-600">(Jabatan yang mewakili pengembang)</p>
          <div className="h-16 flex items-center justify-center text-[7pt] text-slate-400">
...
export const DocBtnStandingInstruction: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-4">
        <p className="text-sm underline uppercase">STANDING INSTRUCTION</p>
        <p className="text-xs uppercase">(Perintah Pemindahbukuan)</p>
      </div>
      ...
      <table className="w-full mb-4 text-[8pt]">
        <tbody>
          <tr><td className="w-44 py-0.5">Nama Pengembang</td><td className="w-3">:</td><td className="font-semibold">{c.pengembang}</td></tr>
      ...
      <p className="text-justify text-[8pt] mb-6 leading-relaxed">
      ...
      <div className="grid grid-cols-2 gap-4 text-center text-[8pt] mt-6">
        <div>
          ...
          <div className="h-16" />
          <p className="font-bold underline">( ................................................................ )</p>
          <p className="text-[7pt] text-slate-600">Nama Lengkap, jabatan, Stempel</p>
        </div>
        <div>
          <p>Purwakarta, .................................... {c.currentYear}</p>
          ...
          <p className="font-bold underline">({c.namaPemohon})</p>
          <p className="text-[7pt] text-slate-600">Nama Lengkap Pembuat SI</p>
        </div>
      </div>
      <p className="text-[6.5pt] italic text-slate-500 mt-6">*) Pilih salah satu</p>
    </PageWrapper>
  );
};
...
export const DocBtnKuasaPendebetanDana: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-6">
        <p className="text-sm underline uppercase">SURAT KUASA PENDEBETAN DANA</p>
        <p className="text-xs uppercase">(BANK BTN)</p>
      </div>
      ...
      <p className="italic text-[8pt] pl-4 -mt-2 mb-4 font-medium">yang dalam hal ini bertindak untuk dan atas nama sendiri, Selanjutnya disebut <span className="font-bold">"Pemberi Kuasa"</span>.</p>
...
export const DocBtnPenghunianRumah: React.FC<{ data: BankKprDocData }> = ({ data }) => {
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-4">
        <p className="text-sm underline uppercase">SURAT PERNYATAAN PENGHUNIAN RUMAH UMUM BERSUBSIDI</p>
        <p className="text-xs uppercase">(BANK BTN)</p>
      </div>
      ...
      <p className="font-semibold text-[8pt] mb-1">Selaku Debitur KPR Bersubsidi BTN menyatakan dengan sesungguhnya bahwa:</p>
      <div className="space-y-1 text-justify text-[7.5pt] leading-snug pl-2">
      ...
      <div className="grid grid-cols-2 gap-2 text-center text-[7.5pt]">
        <div>
          ...
          <div className="h-12" />
          <p className="font-bold underline">({c.namaPasangan || '...................................................'})</p>
          <p className="text-[7pt] text-slate-500">Nama Pasangan suami/istri</p>
        </div>
        <div>
          <p>Yang Membuat Pernyataan,</p>
          <div className="h-12 flex items-center justify-center text-[6.5pt] text-slate-400">
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-3">
        ...
        <p className="text-sm underline uppercase">SURAT PERNYATAAN PEMOHON KPR BERSUBSIDI</p>
        <p className="text-xs uppercase">(FORMAT KEMENTERIAN PUPR)</p>
      </div>
      ...
      <div className="text-center text-[7.5pt] mt-1">
        <p>Mengetahui,</p>
        <p>Pimpinan Tempat Bekerja/Kepala Desa/Lurah* ......................................</p>
        <div className="h-10" />
        <p className="font-bold underline">( ................................................................ )</p>
  ...
  return (
    <PageWrapper>
      <div className="text-center font-bold mb-2">
        ...
        <p className="text-xs uppercase">(FORMAT INTERNAL BANK BTN)</p>
      </div>

      <p className="text-justify text-[7.5pt] mb-2 leading-tight">
      ...
      <table className="w-full mb-1 text-[7.5pt]">
        <tbody>
          <tr><td className="w-36 py-0.5">Nama Lengkap</td><td className="w-3">:</td><td className="font-semibold">{c.namaPemohon}</td></tr>
          <tr><td className="py-0.5">No. KTP</td><td>:</td><td>{c.nikPemohon}</td></tr>
          <tr><td className="py-0.5">Tempat, Tanggal Lahir</td><td>:</td><td>{c.tempatLahirPemohon}, {c.tglLahirPemohon}</td></tr>
          <tr><td className="py-0.5">Pekerjaan</td><td>:</td><td>{c.pekerjaanPemohon}</td></tr>
          <tr><td className="py-0.5 align-top">Alamat</td><td className="align-top">:</td><td className="align-top">{c.alamatPemohon}</td></tr>
      ...
      <p className="italic text-[7pt] pl-4 -mt-1 mb-1 font-medium">Selaku Calon Debitur.</p>

      <table className="w-full mb-1 text-[7.5pt]">
        <tbody>
          <tr><td className="w-36 py-0.5">Nama Lengkap</td><td className="w-3">:</td><td className="font-semibold">{c.namaPasangan || '...................................................'}</td></tr>
          <tr><td className="py-0.5">No. KTP</td><td>:</td><td>{c.nikPasangan || '...................................................'}</td></tr>
          <tr><td className="py-0.5">Tempat, Tanggal Lahir</td><td>:</td><td>{c.tempatLahirPasangan || '........'}, {c.tglLahirPasangan || '........'}</td></tr>
          <tr><td className="py-0.5">Pekerjaan</td><td>:</td><td>{c.pekerjaanPasangan}</td></tr>
          <tr><td className="py-0.5 align-top">Alamat</td><td className="align-top">:</td><td className="align-top">{c.alamatPasangan || c.alamatPemohon}</td></tr>
      ...
      <p className="italic text-[7pt] pl-4 -mt-1 mb-1 font-medium">Selaku suami/istri* Calon Debitur.</p>

      <p className="font-semibold text-[7.5pt] mb-0.5">Menyatakan dengan sesungguhnya bahwa:</p>
      <div className="space-y-0.5 text-justify text-[7pt] leading-tight pl-2">
      ...
      <div className="text-right text-[7pt] mb-1">
        <p>Purwakarta, .................................... {c.currentYear}</p>
        <p className="text-[6.5pt] text-slate-500">Kota/Kabupaten, tanggal bulan tahun</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2 text-center text-[7pt]">
        <div>
          ...
          <div className="h-8" />
          <p className="font-bold underline">({c.namaPasangan || '...................................................'})</p>
          <p className="text-[6.5pt] text-slate-500">Nama Lengkap Suami/Istri*</p>
        </div>
        <div>
          <p>Yang Membuat Pernyataan,</p>
          <div className="h-8 flex items-center justify-center text-[6pt] text-slate-400">
            <span className="border border-dashed border-slate-400 px-1 py-0.5 rounded">Materai 10.000</span>
          </div>
          <p className="font-bold underline">({c.namaPemohon})</p>
          <p className="text-[6.5pt] text-slate-500">Nama Lengkap Pemohon</p>
        </div>
      </div>
